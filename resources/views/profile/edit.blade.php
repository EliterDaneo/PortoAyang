                ...
                <form action="{{ route('profile.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                            value="{{ old('nama', $profile->nama) }}" placeholder="Masukkan Nama Anda">
                        <!-- error message untuk title -->
                        @error('nama')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jurusan') is-invalid @enderror" name="jurusan"
                            value="{{ old('jurusan', $profile->jurusan) }}" placeholder="Masukkan Jurusan Anda">
                        <!-- error message untuk title -->
                        @error('jurusan')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('tentang_saya') is-invalid @enderror" name="tentang_saya" rows="5"
                            placeholder="Masukkan Konten Post">{{ old('tentang_saya', $profile->tentang_saya) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('moto') is-invalid @enderror" name="moto" rows="3">{{ old('moto', $profile->moto) }}</textarea>
                        <!-- error message untuk title -->
                        @error('moto')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ajakan') is-invalid @enderror" name="ajakan"
                            value="{{ old('ajakan', $profile->ajakan) }}">
                        <!-- error message untuk title -->
                        @error('ajakan')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
